...
(defconst gleam-ts--indent-rules
  (let ((offset 'gleam-ts-indent-offset))
    `((gleam
       ...
       ((match "^}$" "^type_definition$") parent-bol 0)
       ...
       ;; ((node-is "data_constructor") parent-bol 0)
       ;; ((node-is "data_constructor_arguments") parent-bol 0)
       ((node-is "data_constructor_argument") parent-bol ,offset)
       ...
       ;; ((parent-is "data_constructors") parent-bol ,offset)
       ;; ((node-is "data_constructors") parent-bol ,offset)
       ;; ((node-is "data_constructor") parent-bol ,offset)
